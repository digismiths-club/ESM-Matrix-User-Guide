    ...
    <>
      <div className='p-4 xl:p-10 pt-20 xl:mt-20 flex flex-wrap gap-5 justify-evenly items-center w-full'>
        <div className='w-[80%] md:w-[40%] flex flex-col min-w-[250px]'> 
          ...
          <div className='xl:mt-2 mt-1 text-sm xl:text-lg'>Drag and drop <b>Task Manager</b></div>
          ...
          {/* <form action="https://crm.zoho.com/market/installPrivatePlugin.do?portalName=digismiths&nameSpace=eisenhowermatrixtaskmanager&versionIndex=4537821000000256001" target="_blank" >
